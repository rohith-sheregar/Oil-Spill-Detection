...
Generates training data and trains the Random Forest look-alike rejection
classifier.

Supports two data modes:
  1. MKLab (real labels): Uses ground-truth oil_spill (class 1) and look_alike
     (class 2) labels from the MKLab dataset directly -- no Module 1 inference
     needed.
  2. SOS (synthetic negatives): Runs Module 1 on SOS oil images and uses
     inverted masks as fake look-alike samples (legacy fallback).
"""
